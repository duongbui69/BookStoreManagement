...
translations = {
    ...
    "Last automated backup completed successfully today at 02:00 AM.": "Bản sao lưu tự động hoàn tất lúc 02:00 SA.",
        ...
        if file.endswith('.cs'):
            ...
            try:
                ...
                for k in sorted_keys:
                    v = translations[k]
                    # Replace only exact double-quoted strings
