...
namespace BookStoreManagement.Forms
{
    public class OrderForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Buttons
            btnCancel = new Guna2Button { Text = "Đóng", Location = new Point(190, yPos), Width = 120, Height = 40, BorderRadius = 4, FillColor = Color.Transparent, BorderThickness = 1, ForeColor = Color.Black, Cursor = Cursors.Hand };
            btnCancel.Click += (s, e) => this.DialogResult = DialogResult.Cancel;
            
            btnSave = new Guna2Button { Text = "Lưu Thay Đổi", Location = new Point(340, yPos), Width = 120, Height = 40, BorderRadius = 4, Cursor = Cursors.Hand };
