...
namespace BookStoreManagement.Forms
{
    public class CategoryForm : Form
    {
        ...
        {
            this.Text = "Manage Categorys";
            this.Size = new Size(1000, 600);
            this.StartPosition = FormStartPosition.CenterParent;
            this.FormBorderStyle = FormBorderStyle.FixedDialog;

                        Panel pnlTop = new Panel { Dock = DockStyle.Top, Height = 80, BackColor = Color.White };
            Label lblSearch = new Label { Text = "Search Category", Font = new Font("Segoe UI", 9F, FontStyle.Bold), ForeColor = Color.DimGray, Location = new Point(20, 15), AutoSize = true };
            ...
            Label lblInputTitle = new Label { Text = "Category Details", Font = new Font("Segoe UI", 12F, FontStyle.Bold), Location = new Point(20, 20), AutoSize = true };
            pnlInput.Controls.Add(lblInputTitle);

            txtId = new TextBox { Visible = false };
            pnlInput.Controls.Add(txtId);

            int y = 60;            Label lblCategoryName = new Label { Text = "CategoryName", Location = new Point(20, y), AutoSize = true };
            txtCategoryName = new TextBox { Location = new Point(20, y + 20), Width = 300, Font = new Font("Segoe UI", 10F) };
            pnlInput.Controls.AddRange(new Control[] { lblCategoryName, txtCategoryName });
