...
namespace BookStoreManagement.Forms
{
    public class PublisherForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            Label lblSearch = new Label { Text = "Search Publisher", Font = new Font("Segoe UI", 9F, FontStyle.Bold), ForeColor = Color.DimGray, Location = new Point(20, 15), AutoSize = true };
            ...
            Label lblInputTitle = new Label { Text = "Publisher Details", Font = new Font("Segoe UI", 12F, FontStyle.Bold), Location = new Point(20, 20), AutoSize = true };
            pnlInput.Controls.Add(lblInputTitle);

            txtId = new TextBox { Visible = false };
            pnlInput.Controls.Add(txtId);

            int y = 60;            Label lblPublisherName = new Label { Text = "PublisherName", Location = new Point(20, y), AutoSize = true };
            txtPublisherName = new TextBox { Location = new Point(20, y + 20), Width = 300, Font = new Font("Segoe UI", 10F) };
            pnlInput.Controls.AddRange(new Control[] { lblPublisherName, txtPublisherName });
