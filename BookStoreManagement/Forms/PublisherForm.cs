...
namespace BookStoreManagement.Forms
{
    public partial class PublisherForm : Form
    {
        ...
        private void InitializeComponentLayout()
        {
            ...
            lblId = new Label { Text = "Mã NXB", Location = new Point(24, startY), AutoSize = true, Font = new Font("Segoe UI", 10) };
            ...
            lblName = new Label { Text = "Tên nhà xuất bản (*)", Location = new Point(24, startY), AutoSize = true, Font = new Font("Segoe UI", 10) };
            ...
            chkIsActive = new CheckBox { Text = "Đang hợp tác", Location = new Point(24, startY + 25), AutoSize = true, Font = new Font("Segoe UI", 10) };
